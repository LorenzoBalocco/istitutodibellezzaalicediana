  ...
  return (
    ...
    >
      <div className="mx-auto max-w-[1280px] px-6 flex items-center justify-between">
        ...
        {/* ── Logo ─────────────────────────────────────── */}
        <Link href="/" className="z-50 flex flex-col leading-none group">
        ...
        {/* ── Hamburger Mobile ─────────────────────────── */}
        <button
          className="lg:hidden z-50 p-2 text-black-soft focus:outline-none"
      ...
      <div
        className={[
          "fixed inset-0 bg-white-pure flex flex-col justify-center items-center",
